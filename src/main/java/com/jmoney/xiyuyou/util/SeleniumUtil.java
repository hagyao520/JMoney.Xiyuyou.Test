package com.jmoney.xiyuyou.util;
...
//		   System.out.println(locatename+"  "+locatevalue);
		   ...
		   switch(locatename){
		   		case "id": 
		   			e = step.getDriver().findElement(By.id(locatevalue));
		   			break;
		   		case "name": 
		   			{
		   				e = step.getDriver().findElement(By.name(locatevalue));
		   			}
		   			break;
		   		case "xpath": 
		   			e = step.getDriver().findElement(By.xpath(locatevalue));
		   			break;
		   		case "tagName": 
		   			e = step.getDriver().findElement(By.tagName(locatevalue));
		   			break;
		   		case "className": 
		   			e = step.getDriver().findElement(By.className(locatevalue));
		   			break;
		   		case "linkText": 
		   			e = step.getDriver().findElement(By.linkText(locatevalue));
		   			break;
		   		case "partialLinkText": 
		   			e = step.getDriver().findElement(By.partialLinkText(locatevalue));
		   			break;
		   		case "cssSelector": 
		   			e = step.getDriver().findElement(By.cssSelector(locatevalue));
		   			break;
		   		default:
